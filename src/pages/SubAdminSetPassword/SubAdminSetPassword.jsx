...
const SubAdminSetPassword = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(
        `https://dream-records-2025-m2m9a.ondigitalocean.app/common/api/v1/authentication/sub-admin-password`,
        payload
      )
      .then((res) => {
        console.log(res);
  ...
  return (
    <div className="logIn-pg">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="login-form-section">
        ...
        <h5>
          You can now access the Dream Records admin panel by setting your
          password.
        </h5>
