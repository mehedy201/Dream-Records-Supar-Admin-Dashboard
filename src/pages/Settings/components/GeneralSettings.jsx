...
function GeneralSettings() {
  ...
  const [releaseRejectionsListFilter, setReleaseRejectionsListFilter] =
    useState([]);
  const [totalReleaseRejectionsList, setTotalReleaseRejectionsList] =
    useState();
  ...
  const [serviceRejectionsListFilter, setServiceRejectionsListFilter] =
    useState([]);
  const [totalServiceRejectionsList, setTotalServiceRejectionsList] =
    useState();
  ...
  const addHomePageNotice = () => {
    ...
    axios
      .post(
        `https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/home-page-notice/add-home-page-notice`,
        payload
      )
      .then((res) => {
        if (res.status == 200) {
  ...
  const deleteHomePageNotice = (id) => {
    axios
      .delete(
        `https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/home-page-notice/${id}`
      )
      .then((res) => {
        if (res.status == 200) {
          setReFetchHomePageNotice(reFetchHomePageNotice + 1);
  ...
  const [withdrawPageInputNoticeText, setWithdrawPageInputNoticeText] =
    useState("");
  ...
  const addWithdrawPageNotice = () => {
    ...
    axios
      .post(
        `https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/withdraw-page-notice/add-withdraw-page-notice`,
        payload
      )
      .then((res) => {
        if (res.status == 200) {
  ...
  const deleteWithdrawPageNotice = (id) => {
    axios
      .delete(
        `https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/withdraw-page-notice/${id}`
      )
      .then((res) => {
        if (res.status == 200) {
  ...
  return (
    <div>
      ...
      <GeneralSettingsList
        ...
        total={totalGenres}
        createLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/genre/add-genre`}
        deleteLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/genre`}
      ...
      <GeneralSettingsList
        ...
        total={totalLanguage}
        createLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/language/add-language`}
        deleteLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/language`}
      ...
      <GeneralSettingsList
        ...
        createLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/release-rejections-list/add-release-rejections-option`}
        deleteLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/release-rejections-list`}
      ...
      <GeneralSettingsList
        ...
        createLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/label-rejections-list/add-label-rejections-option`}
        deleteLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/label-rejections-list`}
      ...
      <GeneralSettingsList
        ...
        createLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/service-rejections-list/add-service-rejections-option`}
        deleteLink={`https://dream-records-2025-m2m9a.ondigitalocean.app/admin/api/v1/settings/service-rejections-list`}
      ...
      >
        ...
        <Collapsible.Content>
          ...
          ></textarea>
          {homePageInputErr && (
            <p style={{ color: "red" }}>{homePageInputErr}</p>
          )}
          <p className="messageBox-time">Max 80 words</p>
          <button onClick={addHomePageNotice} className="theme-btn save-btn">
            Save
          </button>
          <br />
          <br />
            ...
            homePageNotices.map((notice) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <X
                    onClick={() => deleteHomePageNotice(notice._id)}
                    style={{ color: "#ea3958" }}
                  />
                </div>
              </div>
      ...
      >
        ...
        <Collapsible.Content>
          ...
          ></textarea>
          {withdrawPageInputErr && (
            <p style={{ color: "red" }}>{withdrawPageInputErr}</p>
          )}
          <p className="messageBox-time">Max 80 words</p>
          <button
            onClick={addWithdrawPageNotice}
            ...
            withdrawPageNotices.map((notice) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <X
                    onClick={() => deleteWithdrawPageNotice(notice._id)}
                    style={{ color: "#ea3958" }}
                  />
                </div>
              </div>
